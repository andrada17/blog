$(window).ready(function(){
            ...
            success:function(resp) {
               // resp = JSON.parse(resp);
                if (resp.logged ===  false){
                   window.location.href = "https://andrada-curs-andrada17.c9users.io/curs27blogStart/index.html"
                } else {
    ...
    $( "#logout" ).click( function() {
            $.ajax({
            url:"https://andrada-curs-andrada17.c9users.io/curs22-23-24/logout",
            type:"GET",
            success:function(resp) {
