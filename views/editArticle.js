$(window).ready(function(){
    function checkSession(){
        $.ajax({
            url:"https://andrada-curs-andrada17.c9users.io/curs22-23-24/session",
            type:"GET",
            success:function(resp) {
               // resp = JSON.parse(resp);
                if (resp.logged ===  false){
                   window.location.href = "https://andrada-curs-andrada17.c9users.io/curs27blogStart"
                } else {
    ...
    $("[type='submit']").on("click",function(ev){
        ...
        $.ajax({
            url:"https://andrada-curs-andrada17.c9users.io/curs22-23-24/articles/update?id="+id,
            type:"POST",
            data:formData,
            processData:false,
            contentType:false,
            success:function(resp){
                window.location.href = "https://andrada-curs-andrada17.c9users.io/curs27blogStart/pages/articles.html";
            },
            error:function(){
                console.log("oopsss");
            }
